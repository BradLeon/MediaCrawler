...
class XiaoHongShuVideo(AbstractStoreVideo):
    ...
    async def store_video(self, video_content_item: Dict):
        ...
        store video content
        Args:
            video_content_item: dict with notice_id, video_content, extension_file_name
    ...
    async def save_video(self, notice_id: str, video_content: bytes, extension_file_name: str = "mp4"):
        """
        save video to local
        Args:
            notice_id: notice id
